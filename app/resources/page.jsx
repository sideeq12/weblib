...
function Resources() {
  ...
  <path fill-rule="evenodd" d="M11 5.5a.5.5 0 0 0-.5-.5h-5a.5.5 0 0 0 0 1h3.793l-8.147 8.146a.5.5 0 0 0 .708.708L10 6.707V10.5a.5.5 0 0 0 1 0v-5z"/>
               ...
               This site offers design and coding tutorials, UI kits, and other
                resources to help you learn web design and front-end development.
                <span className='ml-3 font-semibold w-[100px] text-blue-500 text-sm flex gap-2 align-middle'>
  ...
  <path fill-rule="evenodd" d="M11 5.5a.5.5 0 0 0-.5-.5h-5a.5.5 0 0 0 0 1h3.793l-8.147 8.146a.5.5 0 0 0 .708.708L10 6.707V10.5a.5.5 0 0 0 1 0v-5z"/>
               ...
               to learn web development, including responsive web design, front-end
                libraries, and more.     <span className='ml-3 font-semibold w-[100px] text-blue-500 text-sm flex gap-2 align-middle'>
                    <Link href='https://www.freecodecamp.org/news/tag/online-courses/'>visit site
                    </Link><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-in-up-right" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M6.364 13.5a.5.5 0 0 0 .5.5H13.5a1.5 1.5 0 0 0 1.5-1.5v-10A1.5 1.5 0 0 0 13.5 1h-10A1.5 1.5 0 0 0 2 2.5v6.636a.5.5 0 1 0 1 0V2.5a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 .5.5v10a.5.5 0 0 1-.5.5H6.864a.5.5 0 0 0-.5.5z"/>
  <path fill-rule="evenodd" d="M11 5.5a.5.5 0 0 0-.5-.5h-5a.5.5 0 0 0 0 1h3.793l-8.147 8.146a.5.5 0 0 0 .708.708L10 6.707V10.5a.5.5 0 0 0 1 0v-5z"/>
</svg></span></li>
               <li> <span className="font-bold"> JavaScript.info : </span>
               his website provides an in-depth and modern JavaScript tutorial,
               s covering the language from the basics to more advanced concepts. 
